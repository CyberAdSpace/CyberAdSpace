...
const brands: Brand[] = [
  {
    ...
    tagline: 'Children-Safe Soaps & Custom Songs',
    description:
      'Emotional, educational brand featuring children-safe soaps & cleaners plus AI-powered custom children\u2019s song creation.',
    longDescription:
      "Antria's Academy is where clean meets creative. Our children-safe soaps and cleaners are crafted with gentle, non-toxic ingredients that parents trust. But we go beyond clean\u2014we create custom children\u2019s songs powered by AI that educate, inspire, and bring joy to little ones everywhere. Every product and song is designed with love, learning, and safety in mind.",
    email: 'AntriasAcademy@CyberAdSpace.com',
    image: null,
    icon: 'Sparkles',
    color: 'from-pink-500/20 to-purple-500/20',
    ctaButtons: [
      { label: 'Shop Cleaners', href: '/brands/antrias-academy', variant: 'primary' },
      { label: 'Create a Kids Song', href: '/kids-song', variant: 'secondary' },
    ],
    featured: true,
  ...
  },
  {
    ...
    ctaButtons: [
      ...
      { label: 'Listen / Releases', href: '/brands/elevated-remedies', variant: 'secondary' },
    ],
    featured: true,
